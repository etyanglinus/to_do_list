...
class TodoApp:
    ...
    def open_in_browser(self, platform):
        web_url = {
            'readme': 'https://github.com/etyanglinus/to-do_list/README.md',
            'youtube': 'https://youtube.com/@linusetyang',
            'github': 'https://github.etyanglinus',
            'linkedin': 'https://linkedin.com/in/linusetyang',
            'twitter': 'https://twitter.com/linusetyang',
